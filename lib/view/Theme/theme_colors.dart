...
class MyThemeColors {
  ...
  // emotions color
  // static const Color emotionGood = Color(0xffB0DD79);
  // static const Color emotionGoodSelected = Color(0xffD7EEBC);
  // static const Color emotionNetural = Color(0xffFEC125);
  // static const Color emotionNeturalSelected = Color(0xffFFE092);
  // static const Color emotionBad = Color(0xffF29D8F);
  // static const Color emotionBadSelected = Color(0xffF8CEC7);

  // confirm or deny button color
  //static const Color confirmColor = Color(0xff58E25D);
  //static const Color denyColor = primaryColor;

  static const MaterialColor myGreyscale = MaterialColor(0xffF9F9F9, {
    0: Color(0xffFFFFFF),
    25: Color(0xffFAFAFA),
    50: Color(0xffF3F3F3),
...
/*
  static const MaterialColor haruPrimary = MaterialColor(0xffED7A64, {
